...
int main(){
  //Задачата може да бъде решена и с динамична памет, тоест вместо MAX_LEN, просто го правите с променлива и си заделяте динамично масива.
    ...
    /**
        ...
        В случая, понеже масива е с дължина MAX_LEN и трябва да запишем терминиращия символ,
